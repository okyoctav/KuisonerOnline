		...
		<thead>
			...
			<?php $no=1;foreach ($dosens as $dosen): ?>
				<tr>
					...
					<td><a href="<?= base_url('prodi/hasil_kuesioner/'.$dosen['id_settings'].'/'.$dosen['id_matkul'].'/'.$dosen['id_dosen']) ?>" class="btn btn-primary btn-xs"><span class="fa fa-eye"></span> Lihat Hasil</a></td>
				</tr>
			<?php $no++;endforeach ?>
	</table>
	<?php }else { ?>
