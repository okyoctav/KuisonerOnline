<div class="panel-body">
	<div class="panel panel-default">
		...
		<div class="panel-body">
            <form class="form-horizontal form-bordered" action="<?= base_url('p2mi/tambah_butir'); ?>" method="post">

                <div class="form-group">
                    <label class="col-sm-2 control-label">Kompetensi Kuesioner</label>
                    <div class="col-sm-8">
                        <select name="id_kompetensi" required class="form-control">
                        <option value="">-- PILIH KOMPETENSI --</option>
                            <?php foreach ($kompetensi_kuesioners as $kompetensi): ?>
                ...
                <div class="form-group textbox">
                    ...
                    <div class="col-sm-8">
                        <input placeholder="Butir Kuesioner.." required class="form-control" name="butir[]" type="text"> 
                    </div>
                    <a href="javascript:void(0)" class="add-box">Add More</a>
                </div><!-- form-group -->
